...
def hierarchyclustering(read_path,save_path,groupsfile='../datasets/Tweemes/groups.pickle'):
    try:
...
def kmedoidsclustering(read_path,save_path,groupsfile='../datasets/Tweemes/groups.pickle'):
    ...
    for metricname,metricmatrix in scores.items():
        ...
        fig.savefig(save_path+metricname+".png",dpi=800)
        fig.clf()
