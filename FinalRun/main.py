...
from clustering_users import GetStabilityClustering, UsersMiniBatchKMeansClustering, UsersDendrogramClustering, ViewNetworks, ColorNetworks, UsersPlotComposition
import shutil
...
UsersPlotComposition("users/5-NormMiniBatchUsersEmbedding.csv","users/")
